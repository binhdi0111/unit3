...
public class MainActivity extends AppCompatActivity {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        if (deviceLocale.equals("FR") || deviceLocale.equals("IL")) {
                            if (deviceLocale.equals("FR")) {
                                ...
                                mPrice *= mFrExchangeRate;
                                double b = mPrice;
                                double a = Double.parseDouble((edtNumber.getText().toString().trim()));
                                txtTotal.setText(Double.toString(a*b));
                            } else {
                                mPrice *= mIwExchangeRate;
                                double b = mPrice;
                                double a = Double.parseDouble((edtNumber.getText().toString().trim()));
                            ...
                            Anhxa();
                            double a = Double.parseDouble((edtNumber.getText().toString().trim()));
                            txtTotal.setText(Double.toString(a*mPrice));
                            mCurrencyFormat = NumberFormat.getCurrencyInstance(Locale.US);
                            myFormattedPrice = mCurrencyFormat.format(mPrice);
    ...
    private void Anhxa() {
        edtNumber = (EditText) findViewById(R.id.quantity);
